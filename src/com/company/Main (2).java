...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            while ((line = bufferedReader.readLine()) != null){
                ...
                zawodnicy.add(new Zawodnik(Integer.valueOf(elements[0]),elements[1],elements[2],Integer.valueOf(elements[3]),Integer.valueOf(elements[4]),Integer.valueOf(elements[5])));
            }
    ...
    public static int Pozycja(ArrayList<Zawodnik> zawodniks, String imieNazwisko){ //zmienić zeby szuakl p samym nazwsku split kropka
